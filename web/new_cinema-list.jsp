...
--%>
                        <td class="td-manage"><a style="text-decoration:none" onClick="pass(this,${cinema.cinemaid })" href="javascript:;" title="通过审核"><i class="Hui-iconfont">&#xe603;</i></a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
