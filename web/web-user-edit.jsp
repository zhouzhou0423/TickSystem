    ...
    <form class="form form-horizontal" id="form-actor-edit">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <input type="hidden" class="userId" id="userId" name="userId" value="${requestScope.userInfo.userid}"/>
                <input type="text" class="input-text" value="${requestScope.userInfo.usertel}"  placeholder="" id="userTel" name="userTel">
            </div>
        </div><br/><br/>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-4">用户名称：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="text" class="input-text" value="${requestScope.userInfo.username}" placeholder="" id="userName" name="userName">
            </div>
        </div><br/><br/>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-4">用户密码：</label>
            <div class="formControls col-xs-8 col-sm-4">
                <input type="password" class="input-text" value="${requestScope.userInfo.userpwd}" placeholder="" id="userPwd" name="userPwd">
            </div>
        </div><br/><br/>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
				<span class="btn-upload form-group">
                    <input class="input-text upload-url" type="text" name="uploadfile-2" id="uploadfile-2" readonly value="${requestScope.userInfo.userphoto}" style="width:200px">
