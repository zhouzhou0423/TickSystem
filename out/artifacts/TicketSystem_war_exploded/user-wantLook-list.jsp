...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 我的想看 <span class="c-gray en">&gt;</span> 想看列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="r">共有数据：<strong>${fn:length(movieInfos)}</strong> 条</span> </div>
	<div class="mt-20">
			...
			<tbody>
				<c:forEach items="${movieInfos }" var="movie">
					<tr class="text-c">
						...
						<td class="td-manage"><a style="text-decoration:none" class="ml-5" onClick="picture_del(this,${movie.movieid })" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
...
function picture_del(obj,id){
	layer.confirm('确认要从想看列表中删除吗？',function(index){
		$.ajax({
			type: 'POST',
