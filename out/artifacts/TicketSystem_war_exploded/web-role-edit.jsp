    ...
    <form class="form form-horizontal" id="form-role-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <input type="hidden" class="roleId" id="roleId" name="roleId" value="${roleInfo.roleid }"/>
                <input type="text" class="input-text" value="${roleInfo.rolename }" placeholder="" id="roleName" name="roleName">
            </div>
        </div>
        <br/>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <span class="select-box">
					<select name="actorId" id="actorId" class="select">
                        <option value="${roleInfo.actorid }">${roleInfo.actorname }</option>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <span class="select-box">
					<select name="movieId" id="movieId" class="select">
                        <option value="${roleInfo.movieid }">${roleInfo.moviename }</option>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <span class="select-box">
					<select name="isImportant" id="isImportant" class="select">
                        <c:if test="${roleInfo.isimportant==0}">
                            <option value="0">导演</option>
                            <option value="1">主演</option>
                            <option value="2">其他演员</option>
                        </c:if>
                        <c:if test="${roleInfo.isimportant==1}">
                            <option value="1">主演</option>
                            <option value="0">导演</option>
                            <option value="2">其他演员</option>
                        </c:if>
                        <c:if test="${roleInfo.isimportant==2}">
                            <option value="2">其他演员</option>
                            <option value="0">导演</option>
                            <option value="1">主演</option>
                        </c:if>
