	...
	<form class="form form-horizontal" id="form-movie-add" enctype="multipart/form-data">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                <input type="hidden" class="movieId" id="movieId" name="movieId" value="${movie.movieid}"/>
				<input type="text" class="input-text" value="${movie.moviename}" placeholder="" id="movieName" name="movieName">
			</div>
		</div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>片长：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${movie.timelimit}" disabled placeholder="" id="timeLimit" name="timeLimit">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>电影简介：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="movieIntro" id="movieIntro" cols="" rows="" class="textarea" placeholder="请输入电影简介..." datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="wordStatic(this);">${movie.movieintro}</textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" onfocus="WdatePicker({ minDate:'%y-%M-%d',dateFmt:'yyyyMMdd' })" id="releaseTime" class="input-text Wdate" name="releaseTime" value="${movie.releasetime}">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>出厂国家：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${movie.nation }" placeholder="" id="nation" name="nation">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class="btn-upload form-group">
                    <input class="input-text upload-url" type="text" name="uploadfile-2" id="uploadfile-2" value="${movie.movieimg}" readonly style="width:200px;margin-left: 14px;">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button id="addBtn" class="btn btn-secondary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 修改</button>
...
<script type="text/javascript">
    ...
    $("#addBtn").click(function () {
        ...
        $.ajax({
            url:"movieManage/updateMovieInfo",
            type:"POST",
            data:formData,
            dataType:"text",
            processData:false,
